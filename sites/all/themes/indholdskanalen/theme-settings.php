...
function indholdskanalen_theme_get_default_settings($theme) {
...
function indholdskanalen_settings($saved_settings, $subtheme_defaults = array()) {

  // Get the default values from the .info file.
  $defaults = indholdskanalen_theme_get_default_settings('indholdskanalen');
  ...
  // Breadcrumb
  $form['navigation']['indholdskanalen_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#size'          => 3,
    '#title'         => t('Breadcrumb separator'),
    '#default_value' => $settings['indholdskanalen_breadcrumb_separator'],
  ...
  $form['stylesheets']['indholdskanalen_stylesheet_conditional'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use IE specific stylesheet conditions in the .info file'),
    '#default_value' => $settings['indholdskanalen_stylesheet_conditional'],
  ...
  $form['typography']['indholdskanalen_typography_links_icons'] = array(
    '#type'          => 'radios',
    ...
    '#default_value' => isset($settings['indholdskanalen_typography_links_icons']) ? $settings['indholdskanalen_typography_links_icons'] : 'no',
  ...
  // $form['misc']['indholdskanalen_aakb_topbar'] = array(
    // '#type'          => 'checkbox',
    // '#title'         => t('Display Aarhus Kommune topbar'),
    // '#default_value' => $settings['indholdskanalen_aakb_topbar'],
  ...
  $form['development']['indholdskanalen_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => $settings['indholdskanalen_rebuild_registry'],
